...
(custom-theme-set-faces
 ...
 '(highlight-numbers-number ((t (:foreground "#79c0aa"))))
 ...
 '(font-lock-comment-delimiter-face ((t (:foreground "#259240"))))
 '(font-lock-comment-face ((t (:foreground "#259240"))))
 ...
 '(font-lock-keyword-face ((t (:foreground "#1d3cf7" :weight normal))))
 ...
 '(font-lock-type-face ((t (:foreground "#1d3cf7" :weight normal))))
